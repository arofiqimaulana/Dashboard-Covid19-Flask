...
def ambil_data_hari_ini():
	...
	data_hari_ini  = {'tanggal':data['data']['tanggal'],
					  ...
					  'spesimen_diperiksa':data['data']['total_spesimen_diperiksa'],
					  'kasus_diperiksa':data['data']['total_kasus_diperiksa'],
					  'negatif_diperiksa':data['data']['total_negatif_diperiksa'],
